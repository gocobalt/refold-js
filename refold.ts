...
class Refold {
    ...
    private async integrate(
        ...
        grant?: string,
    ): Promise<{ auth_url?: string; connected?: boolean; success?: boolean }> {
        ...
        const isClientCredentials = grant === "client_credentials" || !!params?.private_key;
    ...
    private async oauth({
        ...
        const app = await this.getApp(slug).catch(() => undefined);
